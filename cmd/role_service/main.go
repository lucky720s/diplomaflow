...
func main() {
	...
	healthServer.SetServingStatus("role.v1.RoleService", grpc_health_v1.HealthCheckResponse_SERVING)
	...
	healthServer.SetServingStatus("role.v1.RoleService", grpc_health_v1.HealthCheckResponse_NOT_SERVING)
