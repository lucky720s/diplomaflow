-- 1. Таблица Университетов (University Service)
...
-- 2. Таблица Департаментов/Кафедр (University Service)
...
-- 4. Таблица Пользователей (Auth Service)
...
-- Добавляем Департамент (Кафедру) для университета с ID 1
INSERT INTO departments (name, university_id) VALUES
                                                  ('Computer Science', 1),
                                                  ('Software Engineering', 1);

-- Добавляем Роли (связаны с департаментом 1)
