...
type CommitTransitionRequest struct {
	...
	// optional
	SetStatus     string `protobuf:"bytes,12,opt,name=set_status,json=setStatus,proto3" json:"set_status,omitempty"` // "", "active", "completed", ...
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
